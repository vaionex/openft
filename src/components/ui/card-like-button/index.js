...
const CardLikeButton = ({ likeNfts, hasLike }) => {
  return (
    <div
      onClick={likeNfts}
      className="inline-flex items-center justify-center bg-[hsl(231,6%,75%)] bg-opacity-50 border border-lightgray rounded-md cursor-pointer hover:bg-opacity-40 w-11 h-11"
    >
      {hasLike ? (
