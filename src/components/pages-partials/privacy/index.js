          ...
          <div className="px-4 py-16 sm:px-6 lg:px-8 sm:py-24">
            ...
            <div className="mt-12">
              ...
              <p className="max-w-2xl mt-6 text-lg text-mist">
                ...
                to your device. We use cookies to store your preferences and
                settings, to authenticate you when you log in, and to
              ...
              <p className="max-w-2xl mt-6 text-lg text-mist">
                ...
                such as the pages you visit, the time you spend on each page,
                and the links you click. We use this information to improve the
