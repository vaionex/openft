    ...
    <div>
        ...
        <div className="flex relative px-4 mx-auto sm:px-6 lg:max-w-7xl lg:px-8 z-10 top-36 sm:top-52 xl:top-[425px] space-x-1.5 sm:space-x-6">
          {userInfo?.socialLinks?.facebook && (
            <a
              ...
              href={`https://facebook.com/${userInfo?.socialLinks?.facebook}`}
          ...
          {userInfo?.socialLinks?.instagram && (
            <a
              href={`https://instagram.com/${userInfo?.socialLinks?.instagram}`}
              rel="noreferrer noopener"
              target="_blank"
              className="text-gray-100 hover:text-gray-200"
            >
          ...
          {userInfo?.socialLinks?.website && (
            <a
              href={`https://${userInfo?.socialLinks?.website}`}
              rel="noreferrer noopener"
              target="_blank"
              className="text-gray-100 hover:text-gray-200"
            >
      ...
      <div className="max-w-5xl px-4 mx-auto sm:px-6 lg:px-8">
        <div className="flex justify-center -mt-10 sm:-mt-20 sm:space-x-5">
          <div className="relative z-10 flex justify-center w-20 h-20 bg-blue-500 rounded-xl ring-4 ring-white sm:h-40 sm:w-40">
            {userInfo ? (
              ...
              >
                <svg
                  aria-hidden="true"
                  className="w-12 h-12 sm:w-16 sm:h-16 text-gray-200 animate-spin fill-blue-600"
                  viewBox="0 0 100 101"
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                >
