...
import UpdatePaymailDialog from './UpdatePaymailDialog'
...
const UserSettingsWalletSection = () => {
  ...
  const [paymailModal, setpaymailModal] = useState(false)
  ...
  return (
    <>
                    ...
                    <div className="flex items-center justify-center mt-4">
                      ...
                      >
                        <span className="flex flex-row items-center gap-2">
                          ...
                          <SvgAscendingIcon
                            className={
                              !isAscending && 'rotate-180 -scale-x-100'
                            }
                          />
                        </span>
                      </button>
      ...
      {/* //update paymail dialog */}
      <UpdatePaymailDialog
        paymailModal={paymailModal}
        setpaymailModal={setpaymailModal}
        paymail={paymail}
      />
    </>
  )
